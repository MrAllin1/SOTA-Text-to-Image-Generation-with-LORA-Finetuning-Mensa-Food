#!/usr/bin/env python
# train_text_to_image_lora_tb.py
...
def main():
    ...
    writer.add_scalar("benchmark/steps_per_second", sps, 0)
    ...
    # 9) Full training + checkpoints + logging
    ...
    while global_step < args.max_train_steps:
        for batch in dataloader:
            ...
            # log parameter histograms and save checkpoint
            if global_step % args.checkpointing_steps == 0:
                # histogram of LoRA parameters
    ...
    # 10) Final save, close writer & push
    accelerator.wait_for_everyone()
