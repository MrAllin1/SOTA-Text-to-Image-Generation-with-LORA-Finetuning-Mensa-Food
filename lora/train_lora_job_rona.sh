...
accelerate launch train_text_to_image_lora.py \
  ...
  --csv_file="/work/dlclarge2/latifajr-dl_lab_project/mensa_t2i/data/meals_translated_en_with_gpt_03.csv" \
  --resolution=512 \
  --train_batch_size=1 \
  --max_train_steps=30000 \
  --learning_rate=2e-4 \
  --rank=8 \
  --output_dir="./my-lora-model-rona-test-train" \
  --push_to_hub \
  --hub_model_id="username/my-lora-model-rona-test-train"
